...
const logFileLevel = process.env.CSINTERVIEWQUESTIONS_LOG_FILE_LEVEL || 'error';
const logConsoleLevel = process.env.CSINTERVIEWQUESTIONS_LOG_CONSOLE_LEVEL || 'debug';

// Set log file path
const logFilePath = process.env.CSINTERVIEWQUESTIONS_LOG_FILE_PATH || './rubus.log';
